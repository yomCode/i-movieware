...
const Header = () => {
  ...
  return (
    <header>
      <nav className="bg-white border-gray-200 dark:bg-[#111827]">
                ...
                return (
                  <li key={index}>
                    <NavLink
                      ...
                      to={element.path}
                      className={`block py-2 pl-3 pr-4 text-gray-900 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 ${
                        darkMode ? "darkNavLink" : "lightNavLink"
                      }`}
                    >
                      {element?.name}
                    </NavLink>
